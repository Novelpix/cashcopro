...
export function AuditSection() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        setLoading(true);
        // TODO: envoyer les données vers votre CRM / webhook
                    ...
                    >
                        {loading ? (
                            <div className="flex flex-col items-center justify-center h-full py-16 text-center">
                                <div className="w-10 h-10 border-2 border-blue-500 border-t-transparent rounded-full animate-spin mb-5" />
                                <p className="text-gray-500 font-medium text-sm">Envoi en cours…</p>
                            </div>
                        ) : (
